...
* The [CONTROLLER](https://wiki.retrobat.org/controllers/supported-controllers) section is where you have to look for any question related with controls issues
* The [ADVANCED FEATURES](https://wiki.retrobat.org/advanced-features/decorations-and-bezels) section contains information about specific functionalities provided with RetroBat

The RetroBat team has also included some specific [TUTORIALS](https://wiki.retrobat.org/tutorials/know-issues-and-fixes) that will be enhanced by the Team based on common support requirements.
